...
const hackathons = [
    {
        ...
        venue: "Grand Finale — DEVSummit, Bangalore",
        year: "2026",
        icon: "🏆",
        color: "#f59e0b",
        tags: ["AI / InsurTech", "Cloud Innovation", "India-Wide"],
        description:
            "A premier 45-day virtual hackathon for students across India to develop AI-driven InsurTech solutions. Focused on solving real-world insurance challenges through AI, cloud innovation, and mentorship from industry experts.",
        status: "Participated",
        grade: null,
    },
    {
